...
class User {
  ...
  /** Add username and job_id to applications; returns undefined */
  static async apply_for_job(username, job_id){
    console.log(`username: ${username}, job_id: ${job_id}`);
    if(!username || !job_id){ // if no username or job_id, throw error
